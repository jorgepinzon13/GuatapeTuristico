...
public class Rest2Activity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_main) {
            ...
            intent = new Intent(Rest2Activity.this, MainDActivity.class);
            ...
            intent= new Intent(Rest2Activity.this, HotelDActivity.class);
            intent.putExtra("username",username);
            intent.putExtra("email",email);
            startActivity(intent);
            finish();
            ...
            intent= new Intent(Rest2Activity.this, InteresDActivity.class);
            intent.putExtra("username",username);
            intent.putExtra("email",email);
            startActivity(intent);
            finish();
            ...
            intent= new Intent(Rest2Activity.this, BarDActivity.class);
            intent.putExtra("username",username);
            intent.putExtra("email",email);
            startActivity(intent);
            finish();
            ...
            intent= new Intent(Rest2Activity.this, RestDActivity.class);
            intent.putExtra("username",username);
            intent.putExtra("email",email);
            startActivity(intent);
            finish();
            ...
            intent= new Intent(Rest2Activity.this, LoginActivity.class);
            intent.putExtra("username",username);
            intent.putExtra("email",email);
            startActivity(intent);
            finish();
